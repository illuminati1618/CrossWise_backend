...
input_file = "datasets/april.json"
...
# If you want to save the figure as an HTML file for interactive viewing
fig.write_html("border_wait_times.html")
print("Visualization saved to border_wait_times.html")